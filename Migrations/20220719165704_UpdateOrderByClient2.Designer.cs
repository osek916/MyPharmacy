...
namespace MyPharmacy.Migrations
{
    ...
    [Migration("20220719165704_UpdateOrderByClient2")]
    partial class UpdateOrderByClient2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyPharmacy.Entities.Drug", b =>
                {
                    ...
                    b.Property<int?>("OrderForPharmacyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyPharmacy.Entities.EmailParams", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyPharmacy.Entities.OrderForPharmacy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyPharmacy.Entities.Drug", b =>
                {
                    ...
                    b.HasOne("MyPharmacy.Entities.OrderForPharmacy", null)
                        .WithMany("Drugs")
                        .HasForeignKey("OrderForPharmacyId");
            ...
            modelBuilder.Entity("MyPharmacy.Entities.EmailParams", b =>
                {
                    b.HasOne("MyPharmacy.Entities.Pharmacy", "Pharmacy")
                        .WithOne("EmailParams")
                        .HasForeignKey("MyPharmacy.Entities.EmailParams", "PharmacyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
